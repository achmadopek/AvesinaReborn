...
// THP
app.use(
  "/api/thp/DashboardTHP",
  require("./routes/wj_thp/DashboardTakeHomePay"),
);
app.use("/api/thp/MasterKeuangan", require("./routes/wj_thp/MasterKeuangan"));
app.use(
  "/api/thp/KomponenPenghasilan",
  require("./routes/wj_thp/KomponenPenghasilan"),
);
app.use(
  "/api/thp/KomponenPotongan",
  require("./routes/wj_thp/KomponenPotongan"),
);
app.use(
  "/api/thp/ImportGajiPegawai",
  require("./routes/wj_thp/ImportGajiPegawai"),
);
app.use(
  "/api/thp/ImportJPJMPegawai",
  require("./routes/wj_thp/ImportJPJMPegawai"),
);
app.use(
  "/api/thp/PenghasilanPegawai",
  require("./routes/wj_thp/PenghasilanPegawai"),
);
...
app.use(
  "/api/mibers/MasterAnjungan",
  require("./routes/wj_mibers/MasterAnjungan"),
);
app.use(
  "/api/mibers/MonitoringAplicares",
  require("./routes/wj_mibers/MonitoringAplicares"),
);
app.use(
  "/api/mibers/MonitoringIcare",
  require("./routes/wj_mibers/MonitoringIcare"),
);
app.use(
  "/api/mibers/MonitoringAntrian",
  require("./routes/wj_mibers/MonitoringAntrian"),
);
app.use(
  "/api/mibers/MonitoringSatuSehat",
  require("./routes/wj_mibers/MonitoringSatuSehat"),
);
app.use(
  "/api/mibers/MonitoringTHP",
  require("./routes/wj_mibers/MonitoringTHP"),
);
app.use(
  "/api/mibers/MonitoringDisplay",
  require("./routes/wj_mibers/MonitoringDisplay"),
);
app.use(
  "/api/mibers/MonitoringVisite",
  require("./routes/wj_mibers/MonitoringVisite"),
);

// SPM
app.use("/api/spm/MasterUnit", require("./routes/wj_spm/MasterUnitRoutes"));
app.use(
  "/api/spm/EntriSPMHarian",
  require("./routes/wj_spm/EntriSPMHarianRoutes"),
);
...
app.use(
  "/api/spm/VerifikasiSPMHarian",
  require("./routes/wj_spm/VerifikasiSPMHarianRoutes"),
);
...
app.use(
  "/api/inm/VerifikasiINMHarian",
  require("./routes/wj_inm/VerifikasiINMHarianRoutes"),
);
...
app.use(
  "/api/mobay/PengajuanTagihan",
  require("./routes/wj_mobay/PengajuanTagihanRoutes"),
);
app.use(
  "/api/mobay/PengirimanBerkas",
  require("./routes/wj_mobay/PengirimanBerkasRoutes"),
);
app.use(
  "/api/mobay/PenerimaanBerkas",
  require("./routes/wj_mobay/PenerimaanBerkasRoutes"),
);
app.use(
  "/api/mobay/VerifikasiPengajuan",
  require("./routes/wj_mobay/VerifikasiPengajuanRoutes"),
);
app.use(
  "/api/mobay/PembayaranTagihan",
  require("./routes/wj_mobay/PembayaranTagihanRoutes"),
);
app.use(
  "/api/mobay/MonitoringTagihan",
  require("./routes/wj_mobay/MonitoringTagihanRoutes"),
);
app.use(
...
// Antrian
app.use(
  "/api/antrian/AntrianPasien",
  require("./routes/wj_antrian/AntrianPasien"),
);

// MCU
app.use("/api/mcu/DataMCU", require("./routes/wj_mcu/DataMCURoutes"));
app.use(
  "/api/mcu/DataPasienMCU",
  require("./routes/wj_mcu/DataPasienMCURoutes"),
);
...
app.use(
  "/api/mcu/DataBiometrik",
  require("./routes/wj_mcu/DataBiometrikRoutes"),
);

// WAVA
app.use(
  "/api/wava/VirtualAssistant",
  require("./routes/wava/PrologWavaRoutes"),
);

// BUGARR
app.use(
  "/api/bugarr/MonitoringBugarr",
  require("./routes/wj_bugarr/MonitoringBugarrRoutes"),
);

// SIRAD
app.use(
  "/api/sirad/MonitoringXRay",
  require("./routes/wj_sirad/MonitoringXRayRoutes"),
);
app.use(
  "/api/sirad/MonitoringCTScan",
  require("./routes/wj_sirad/MonitoringCTScanRoutes"),
);

// TERJANG
app.use(
  "/api/terjang/TrackingPenunjang",
  require("./routes/wj_terjang/TrackingPenunjangRoutes"),
);

// SUPERVISI
app.use(
  "/api/supervisi/Supervisi",
  require("./routes/wj_supervisi/SupervisiRoutes"),
);
app.use(
  "/api/supervisi/DireksiIssue",
  require("./routes/wj_supervisi/DireksiIssueRoutes"),
);
app.use(
