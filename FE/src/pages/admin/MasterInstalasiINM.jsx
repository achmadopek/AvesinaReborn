...
import InstalasiINMModal from "./InstalasiINMModal";

const MasterInstalasiINM = ({ limit = 10 }) => {
    ...
    <>
      ...
      <div className="card shadow-sm">
        <div className="card-header py-2 px-3">
          <h6 className="mb-0">Master Instalasi INM</h6>
        </div>
...
export default MasterInstalasiINM;
