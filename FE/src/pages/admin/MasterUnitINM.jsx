...
import { fetchPaginatedData, deleteUnit } from "../../api/admin/MasterUnitINM";
import UnitINMModal from "../admin/UnitINMModal";

const MasterUnitINM = ({ isMobile, limit = 10 }) => {
  ...
  const loadData = async () => {
    try {
      const res = await fetchPaginatedData(page, limit, searchKode, searchNama);
    ...
    <>
      ...
      <div className="card shadow-sm card-theme">
        <div className="card-header py-2 px-3">
          <h6 className="mb-0">Master Unit INM</h6>
        </div>
