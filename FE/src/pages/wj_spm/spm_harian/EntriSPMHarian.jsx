...
const EntriSPMHarian = () => {
    ...
    setIndikatorGroup((prev) =>
      prev.map((group) => ({
        ...
        indikator: group.indikator.map((item) => {
          ...
          const num =
            field === "numerator_value" ? val : updated.numerator_value;
  ...
  const handleSubmit = async () => {
    ...
    const result = await Swal.fire({
      title: "Simpan Data?",
      text: "Data akan disimpan dan sistem akan otomatis mendownload bukti PDF sebagai tanda bahwa Anda telah melakukan entri.",
      icon: "question",
      showCancelButton: true,
