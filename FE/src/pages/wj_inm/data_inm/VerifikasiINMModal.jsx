...
import { verifikasiINMHarian } from "../../../api/wj_inm/VerifikasiINM";
import { toast } from "react-toastify";
import { useAuth } from "../../../context/AuthContext";

const VerifikasiINMModal = ({ show, onClose, data }) => {
  ...
  return (
    <Modal show={show} onHide={() => onClose(false)} size="lg">
      <Modal.Header closeButton>
        <Modal.Title>Verifikasi INM</Modal.Title>
      </Modal.Header>
...
export default VerifikasiINMModal;
