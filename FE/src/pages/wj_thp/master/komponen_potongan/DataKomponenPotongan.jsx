  ...
  return (
    <div className="card shadow-sm card-theme mt-3">
      <div className="card-header py-2 px-3">
        <h6 className="mb-0">Data Komponen Potongan</h6>
      </div>
          ...
          <table className="table table-theme table-sm table-bordered">
            ...
            <tbody>
              {Array.isArray(data) && data.length > 0 ? (
                data.map((item, index) => (
                  <tr key={item.potongan_code || index}>
                    ...
                    <td>
                      {item.satuan === "persen"
                        ? `${formatNumber(item.default_nilai)} %`
                        : `Rp. ${formatNumber(item.default_nilai)}`}
                    </td>
                    <td>{item.jenis}</td>
                  </tr>
                ))
...
export default DataKomponenPotongan;
