...
export const Laporan = ({ setShowSidebar, isMobile, setShowRightContent }) => {
                ...
                {openMenus.Laporan && (
                    <ul className="submenu">
                        ...
                        <li className="submenu-item-x">
                            <Link to={`/thp/LaporanTHP`} onClick={() => { if (isMobile) setShowSidebar(false); setShowRightContent(true); }} className="submenu-link">
                                <div className="d-flex align-items-center">
                                    <i className="fas fa-file-export fa-md me-2"></i>
                                    <span>Laporan THP</span>
                                </div>
                            </Link>
                        </li>
