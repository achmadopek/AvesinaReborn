...
export const KamarJenazah = ({ setShowSidebar, isMobile, setRightContent }) => {
    ...
    return (
        ...
        {/* First-level Dropdown */}
            ...
            <ul className="submenu">
                ...
                <Link to="/under-construction" onClick={() => { if (isMobile) setShowSidebar(false); }} className="submenu-link">Kamar Jenazah</Link>
                </li>

                <li className="submenu-item">
                <Link to="/under-construction" onClick={() => { if (isMobile) setShowSidebar(false); }} className="submenu-link">Monitoring Kematian</Link>
                </li>
