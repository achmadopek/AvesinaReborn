...
export const Penunjang = ({ setShowSidebar, isMobile, setRightContent }) => {

    // Track the state of each dropdown (menu, submenu, and sub-submenu)
    const [openMenus, setOpenMenus] = useState({
        Penunjang: true,        // Main dropdown "Services"
    ...
    return (
        ...
        <div>
            ...
            <li className="sidebar-item-x">
                <Link to="#" onClick={() => toggleDropdown('Penunjang')} className="sidebar-link-x d-flex justify-content-between align-items-center">
                    <div className="d-flex align-items-center">
                        <i className="fas fa-microscope fa-fw me-2"></i> {/* Ikon Master */}
                        <span>Penunjang</span>
                    </div>
                    <i className={`fa ${openMenus.Penunjang ? 'fa-chevron-up' : 'fa-chevron-down'} dropdown-arrow`}></i>
                </Link>
                {openMenus.Penunjang && (
                    <ul className="submenu">
                        <li className="submenu-item">
                            ...
                            {openMenus.LaporanInventory && (
                                <ul className="submenu">
                                    <li className="submenu-item">
                                        <Link to={`/mobay/KonsolidasiTagihan`} className="submenu-link-xx d-flex align-items-center">
                                            <i className="far fa-circle fa-xs me-2"></i>
                                            <span>Konsolidasi Tagihan</span>
                                        </Link>
                                    </li>
                                    <li className="submenu-item">
                                        <Link to={`/mobay/PengajuanTagihan`} className="submenu-link-xx d-flex align-items-center">
                                            <i className="far fa-circle fa-xs me-2"></i>
