    ...
    <div>
      ...
      <li className="sidebar-item-x">
        ...
        >
          ...
          <i
            className={`fa ${openMenus.Laporan ? "fa-chevron-up" : "fa-chevron-down"} dropdown-arrow`}
          ></i>
        </Link>
        {openMenus.Laporan && (
          <ul className="submenu">
            <li className="submenu-item-x">
              <Link
                to="#"
                onClick={() => toggleDropdown("LaporanSPM")}
                className="submenu-link d-flex justify-content-between"
              >
                <div className="d-flex align-items-center">
                ...
                <i
                  className={`fa ${openMenus.LaporanSPM ? "fa-chevron-up" : "fa-chevron-down"} dropdown-arrow`}
                ></i>
              </Link>
              {openMenus.LaporanSPM && (
                <ul className="submenu">
                  <li className="submenu-item">
                    <Link
                      to="/spm/RekapKepatuhanSPM"
                      className="submenu-link-xx d-flex align-items-center"
                    >
