...
export const roleAccess = {
  ...
  penunjang: ["Beranda", "Penunjang", "LaporanMobay", "Terjang"],
  ...
  radiografer: ["Beranda", "Sirad", "Terjang"],
  radiolog: ["Beranda", "Sirad", "Terjang"],

  // Role klinis/penunjang dapat mengakses Terjang
  dokter: ["Beranda", "Terjang"],
  perawat: ["Beranda", "Terjang"],
};
